...
//         <h1 className="text-2xl font-bold">Hire1Percent</h1>
//         <div>
//           <button className="mx-2 px-4 py-2 bg-blue-500 text-white rounded">Sign Up</button>
//           <button className="mx-2 px-4 py-2 border border-blue-500 text-blue-500 rounded">Login</button>
//         </div>
//       </nav>
...
//       {/* Hero Section */}
//       <section className="text-center py-20 bg-gray-100 px-6">
//         <h2 className="text-4xl font-bold mb-4">Top 1% Talent for the Best Companies</h2>
//         <p className="text-lg text-gray-600">Connecting elite candidates with great opportunities.</p>
//       </section>
...
//           We source, vet, and connect top-tier professionals with leading companies using proprietary dashboards and streamlined processes.
//         </p>
//       </section>
...
//         <p className="text-gray-700">
//           Using advanced selection pipelines, admin dashboards, and transparent communication, we maintain efficiency and quality.
//         </p>
//       </section>
...
//         <p className="text-gray-700">
//           Hire1Percent is founded by industry experts committed to changing the way companies hire top talent by focusing on the best 1% of candidates.
//         </p>
//       </section>
...
//           <MapContainer center={[28.6139, 77.209]} zoom={13} className="h-full w-full rounded z-0">
//             <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
//             <Marker position={[28.6139, 77.209]}>
//               <Popup>Hire1Percent HQ - Delhi, India</Popup>
//             </Marker>
//           </MapContainer>
//         </div>
//       </section>
...
//         <p className="text-gray-600">© {new Date().getFullYear()} Hire1Percent. All rights reserved.</p>
//       </footer>
//     </div>
//   );
// }
...
//       if (res.ok) {
//        setFormData({ name: '', email: '', message: '' }); // ✅ Clears all fields
...
//       {/* Navigation Bar */}
//       <header className="fixed top-0 w-full z-50 shadow bg-white/80 backdrop-blur-md">
//         <nav className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
//           <h1 className="text-2xl font-bold text-blue-700">Hire1Percent</h1>
//           <div className="space-x-4">
//             <button className="px-4 py-2 rounded-md bg-blue-600 text-white hover:bg-blue-700 transition">Sign Up</button>
//             <button className="px-4 py-2 rounded-md border border-blue-600 text-blue-600 hover:bg-blue-50 transition">Login</button>
//           </div>
//         </nav>
//       </header>

//       {/* Hero Section */}
//       <section className="min-h-screen flex flex-col justify-center items-center text-center bg-gradient-to-r from-blue-50 via-white to-blue-100 px-6 pt-24">
//         <h2 className="text-5xl font-bold text-blue-800 mb-6">Top 1% Talent for the Best Companies</h2>
//         <p className="text-lg text-gray-600 max-w-xl mb-6">
//           We connect elite candidates with leading companies using smart, transparent, and efficient hiring processes.
//         </p>
//         <button className="px-6 py-3 bg-blue-700 text-white text-lg rounded-lg shadow hover:bg-blue-800 transition">
//           Get Started
//         </button>
//       </section>
...
//         <h3 className="text-3xl font-bold mb-6 text-blue-800">What We Do</h3>
//         <p className="text-gray-700 text-lg leading-relaxed">
//           We source, vet, and connect top-tier professionals with leading companies using proprietary dashboards, automated pipelines, and rigorous selection.
//         </p>
//       </section>
...
//           <h3 className="text-3xl font-bold mb-6 text-blue-800">How We Do It</h3>
//           <p className="text-gray-700 text-lg leading-relaxed">
//             Our process includes automated assessments, real-time dashboards for admins and clients, and a transparent communication workflow.
//           </p>
//         </div>
//       </section>
...
//       {/* About Us */}
//       <section className="max-w-6xl mx-auto px-6 py-20">
//         <h3 className="text-3xl font-bold mb-6 text-blue-800">About Us</h3>
//         <p className="text-gray-700 text-lg leading-relaxed">
...
//           <h3 className="text-2xl font-bold mb-6 text-blue-800 text-center">Contact Us</h3>
...
//         <p className="text-sm">© {new Date().getFullYear()} Hire1Percent. All rights reserved.</p>
//       </footer>
//     </div>
//   );
// }
